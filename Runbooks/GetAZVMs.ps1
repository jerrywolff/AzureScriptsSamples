...
$subsscription = "MSUSHPC2022"

#$Sub_Name = (Get-azAutomationVariable -Name "MSUSHPC2022" -ResourceGroupName 'wolffautorg' –AutomationAccountName "wolffautoacct").value
Get-azSubscription –SubscriptionName $subsscription | Select-azSubscription
