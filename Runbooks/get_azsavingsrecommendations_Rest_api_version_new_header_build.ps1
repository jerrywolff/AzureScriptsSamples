...
If(!($ExportFile))
{
    $ExportFile = "c:\temp\azstoragemetrics.csv"
} 
...
$datestart = get-date($date) -Format 'yyyyMM'     
 ...
 $resultsfilename = "savingsrecommendation.csv"
...
#############>
        ...
        # Output the response
         $response
             ...
             $($usageresponse.value).properties | export-csv $resultsfilename -NoTypeInformation -Append 
